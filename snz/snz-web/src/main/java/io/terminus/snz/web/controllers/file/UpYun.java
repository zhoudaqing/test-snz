...
@Slf4j
public class UpYun implements FileServer {
     ...
     * @return UpYun object
     */
    public UpYun(String baseUrl, String bucketName, String userName,
                 String password) {
    ...
    public String write(String fileName, MultipartFile file) throws FileUploadException {
        try {
            ...
            boolean isSucceed = writeFile(fileName,fileData,true);
            if(!isSucceed){
                throw new FileUploadException("Write failed");
            }
        } catch (Exception e) {
